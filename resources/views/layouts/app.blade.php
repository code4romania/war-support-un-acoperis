        ...
        <div class="bg-gray-100">
            <div class="container d-flex items-center py-3">
                <svg class="h6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 121.9">
                    ...
                    <path d="M93,119.4l-22.1,2.5V61h55.7Z" fill="#bcbcbc" />
                    <path d="M93,2.5,70.9,0V61h55.7Z" fill="#e9e9e9" />
        ...
        <div class="container flex flex-wrap justify-content-end">
            <div class="inline-flex items-center justify-content-between py-4">
                ...
                <div class="grid items-center">
                    <img src="/images/gov_ro.svg" class="inline-block ml-2 h-5" alt="Romanian GOV Logo">
                </div>
                <div class="grid items-center">
                    <a href="http://www.dsu.mai.gov.ro/" target="_blank" rel="noopener" class="inline-block ml-2">

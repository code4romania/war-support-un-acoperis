...
<footer class="footer bg-brand-blue text-white pt-5">
    <div class="container row d-flex justify-content-between p-2 mx-auto">        
        ...
        <div class="d-flex flex-column align-items-end col-12 col-sm-6 mt-5 pl-2">
            <img class="mb-4"  src="/images/logo-code4ro.png" alt="">

<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <form action="{{route('admin.allocate.user.to.host', ['id' => $accommodation->id])}}" method="post">
            ...
            <div class="form-row">
                <div class="col">
                    <input class="form-control @error('help_request_id') is-invalid @enderror" id="helpRequestID" name="help_request_id"
                ...
                <div class="col">
                    <input class="form-control  @error('guests_number') is-invalid @enderror" id="helpRequestID" name="guests_number"

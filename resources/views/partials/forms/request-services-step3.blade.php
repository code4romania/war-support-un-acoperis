    ...
    <div class="container">
        <div class="accordion-1 request-services">
            <form method="POST" action="{{ $formRoute }}" id="sendRequest">
                <input type="hidden" name="request_services_step"
                       value="{{\App\Http\Requests\ServiceRequest::SERVICE}}">
                @csrf
                <div class="row">
                                ...
                                <div id="generalInformation" class="collapse show"
                                    ...
                                    <div class="card-body py-5">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <label class="required font-weight-600"
                                                       for="destination">{{ __('Destination') }}
                                                    :</label>
                                                <input type="text"
                                                       placeholder="@lang('destination_location_placeholder')"

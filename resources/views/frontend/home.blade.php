    ...
    <div class="container py-sm-6 py-3">
        ...
        <div class="d-flex align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="banner-content ml-sm-5 mt-3 mt-sm-0">
                ...
                <a href="{{ route('request-services') }}" class="btn btn-lg btn-primary mr-3 px-5">Solicita servicii</a>
                <a href="{{ route('get-involved') }}" class="btn btn-lg btn-secondary px-5">Implica-te</a>
            </div>
        </div>
    </div>

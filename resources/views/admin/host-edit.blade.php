...
@section('content')
    <section class="mb-5">
        ...
        <a href="{{ route('admin.host-detail', ['id' => $user->id]) }}" class="btn btn-sm btn-outline-primary mr-3">{{ __("Back") }}</a>
    </section>
    ...
    <div class="card shadow">
        ...
        <div class="card-body pt-4">
            <form action="{{ @route('admin.host-edit', ['id' => $user->id]) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            @include('partials.phone', ['controlName' => 'phone', 'controlDefault' => $user->phone_number, 'prefixes' => $countries, 'prefixValue' => $user->phoneCountry ? $user->phoneCountry->phone_prefix : '', 'prefixCode' => $user->phoneCountry ? $user->phoneCountry->code : 'RO'])
                            @error('phone')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        </div>

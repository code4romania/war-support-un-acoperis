                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            @include('partials.phone', ['controlName' => 'phone', 'controlDefault' => $user->phone_number, 'prefixes' => $countries, 'prefixValue' => $user->phoneCountry->phone_prefix, 'prefixCode' => $user->phoneCountry->code ])

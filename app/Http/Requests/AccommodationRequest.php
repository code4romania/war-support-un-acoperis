...
class AccommodationRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules =  [
            ...
            'max_guests' => ['required', 'numeric', 'min:1', 'max:10000'],
            'available_rooms' => ['required', 'numeric', 'min:1', 'max:10000'],
            'available_beds' => ['required', 'numeric', 'min:1', 'max:10000'],
            'available_bathrooms' => ['required', 'numeric', 'min:1', 'max:10000'],

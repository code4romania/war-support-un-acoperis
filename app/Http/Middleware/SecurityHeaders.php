        ...
        if (method_exists($response, 'header')) {
            ...
            if (app()->environment(['production', 'development'])) {
                $response->headers->add(
                    [
                        'Content-Security-Policy' => "default-src fonts.googleapis.com *.amazonaws.com *.google.com www.googletagmanager.com www.google-analytics.com impreunapentrusanatate.ro dev.impreunapentrusanatate.ro; script-src 'self' 'unsafe-inline' 'unsafe-eval' *.google.com www.googletagmanager.com www.google-analytics.com www.gstatic.com polyfill.io maps.googleapis.com cdn.jsdelivr.net cdn.tiny.cloud cdnjs.cloudflare.com; object-src 'none'; style-src 'self' 'unsafe-inline' fonts.googleapis.com cdnjs.cloudflare.com cdn.tiny.cloud; img-src 'self' data: *.amazonaws.com maps.googleapis.com maps.gstatic.com sp.tinymce.com; frame-src 'self' *.google.com www.googletagmanager.com www.google-analytics.com; font-src 'self' fonts.googleapis.com fonts.gstatic.com; connect-src 'self' www.google-analytics.com  *.doubleclick.net;",

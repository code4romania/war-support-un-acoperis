        ...
        if (method_exists($response, 'header')) {
            ...
            if (app()->environment(['production', 'development'])) {
                $response->headers->add(
                    [
                        'Content-Security-Policy' => "default-src fonts.googleapis.com *.amazonaws.com *.google.com impreunapentrusanatate.ro dev.impreunapentrusanatate.ro; script-src 'self' 'unsafe-inline' 'unsafe-eval' *.google.com www.gstatic.com polyfill.io maps.googleapis.com; object-src 'none'; style-src 'self' 'unsafe-inline' fonts.googleapis.com; img-src 'self' data: *.amazonaws.com maps.googleapis.com maps.gstatic.com; frame-src 'self' *.google.com; font-src 'self' fonts.googleapis.com fonts.gstatic.com;",
